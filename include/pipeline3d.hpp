...
public:
    ...
    void transformInto(const std::vector<tmx::vec3>& vs, std::vector<tmx::vec4>& out) const;
    void transformIntoParallel(const std::vector<tmx::vec3>& vs, std::vector<tmx::vec4>& out, unsigned threads) const;
